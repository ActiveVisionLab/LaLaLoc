...
_C.INPUT.LAYOUT_SIZE = (256, 512)
_C.INPUT.NORMALISE_MEAN = [0.485, 0.456, 0.406]
_C.INPUT.NORMALISE_STD = [0.485, 0.456, 0.406]
# _C.INPUT.NORMALISE_STD = [0.229, 0.224, 0.225] # A bug meant that this was also used as the STD for LaLaLoc configs
...
_C.DATASET.PIX_PER_MM = 0.025
_C.DATASET.FLOORPLAN_DIVISIBLE_BY = 32
...
_C.MODEL.PANO_EMBEDDER_TYPE = "fc"
_C.MODEL.LAYOUT_EMBEDDER_TYPE = "fc"
_C.MODEL.DECODER_RESOLUTION = (32, 64)
_C.MODEL.NORMALISE_SAMPLE = False

_C.MODEL.UNET_ENCODER_CHANNELS = [32, 64, 128, 256, 512]
_C.MODEL.UNET_DECODER_CHANNELS = [512, 256, 128, 64, 32, 128]

_C.MODEL.PANORAMA_MODULE = CN()
_C.MODEL.PANORAMA_MODULE.POS_AT_INPUT = True
_C.MODEL.PANORAMA_MODULE.NUM_BLOCKS = 2
_C.MODEL.PANORAMA_MODULE.HIDDEN_DIM = 2048
...
_C.TEST.METRIC_DUMP = ""
_C.TEST.COMPUTE_GT_DIST = True
_C.TEST.SUBSAMPLE_PLAN_X = 1
